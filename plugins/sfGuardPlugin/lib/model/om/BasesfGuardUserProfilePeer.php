...
abstract class BasesfGuardUserProfilePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'FirstName', 'LastName', 'Company', 'Email', 'Homepage', 'Birthday', ),
		BasePeer::TYPE_COLNAME => array (sfGuardUserProfilePeer::ID, sfGuardUserProfilePeer::USER_ID, sfGuardUserProfilePeer::FIRST_NAME, sfGuardUserProfilePeer::LAST_NAME, sfGuardUserProfilePeer::COMPANY, sfGuardUserProfilePeer::EMAIL, sfGuardUserProfilePeer::HOMEPAGE, sfGuardUserProfilePeer::BIRTHDAY, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'first_name', 'last_name', 'company', 'email', 'homepage', 'birthday', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'FirstName' => 2, 'LastName' => 3, 'Company' => 4, 'Email' => 5, 'Homepage' => 6, 'Birthday' => 7, ),
		BasePeer::TYPE_COLNAME => array (sfGuardUserProfilePeer::ID => 0, sfGuardUserProfilePeer::USER_ID => 1, sfGuardUserProfilePeer::FIRST_NAME => 2, sfGuardUserProfilePeer::LAST_NAME => 3, sfGuardUserProfilePeer::COMPANY => 4, sfGuardUserProfilePeer::EMAIL => 5, sfGuardUserProfilePeer::HOMEPAGE => 6, sfGuardUserProfilePeer::BIRTHDAY => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'first_name' => 2, 'last_name' => 3, 'company' => 4, 'email' => 5, 'homepage' => 6, 'birthday' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
