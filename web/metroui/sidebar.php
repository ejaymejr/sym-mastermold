...
<body class="metro">
    ...
    <div class="container">
                <h1>
                    ...
                    Sidebar<small class="on-right">component</small>
                </h1>

                <p class="description">
                    Metro UI CSS provides <code>SideBar</code> component. This component is great to create side menu.
                    For <strong>dropdown</strong> you must include <code>metro-dropdown.js</code>.
