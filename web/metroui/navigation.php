...
<div class="nav-bar">
    <div class="nav-bar-inner padding10">
        ...
        <a href="/"><span class="element brand">
            ...
            T.C. Khoo Pte Ltd <small><?= include("version.phtml")?></small>
        </span></a>
        ...
        <ul class="menu">
            ...
            <li data-role="dropdown"><a href="#">Components</a>
                <ul class="dropdown-menu">
                    ...
                    <li class="divider"></li>
                    <li><a href="flare.php">Flare - Eman</a></li>
                    <li><a href="amcharts.php">Am Charts - Eman</a></li>
                    <li><a href="generatePdf.php">PDF Library - Eman</a></li>
                    <li class="divider"></li>
