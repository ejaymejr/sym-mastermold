...
<body class="metro">
    ...
    <div class="container">
                <h1>
                    ...
                    Icons<small class="on-right">font</small>
                </h1>
...
&lt;link href="iconFont.css" rel="stylesheet"&gt;
                ...
                <p class="padding10 tertiary-text bg-grayLighter">
                    Also you can use your own icons, for example <a href="http://fortawesome.github.io/Font-Awesome/">Font Awesome</a>
                </p>

                <p class="description">
                    Place Metro UI CSS icons just about anywhere with the <code>&lt;i&gt;</code> or <code>&lt;span&gt;</code> tags.
                </p>
                <div class="example">
                    <h1><i class="icon-rocket"></i> icon-rocket</h1>
                </div>
<pre class="prettyprint linenums">
...
&lt;span class="icon-rocket"&gt;&lt;/span&gt;
                ...
                <p class="description">
                    You can use build-in classes <code>.on-left</code>, <code>.on-right</code> to add margin <strong>5px</strong> between icon and text and <code>.on-left-more</code>, <code>.on-right-more</code> to add margin <strong>10px</strong>.
                </p>
...
&lt;i class="icon-rocket on-left"&gt;&lt;/i&gt;icon-rocket
            ...
            <div class="example">
                    <h3>icon-rocket<i class="icon-rocket on-right"></i></h3>
                </div>
<pre class="prettyprint linenums">
icon-rocket&lt;i class="icon-rocket on-right"&gt;&lt;/i&gt;
                ...
                <div class="example">
                    <h3>icon<i class="icon-rocket on-left on-right"></i>rocket</h3>
                </div>
<pre class="prettyprint linenums">
icon&lt;i class="icon-rocket on-right on-left"&gt;&lt;/i&gt;rocket
</pre>

                <p class="description">Also you can change color style for icon with build-in color classes.</p>
                <div class="example">
                    <h3>icon<i class="icon-rocket fg-red on-left on-right"></i>rocket</h3>
                </div>
<pre class="prettyprint linenums">
...
<pre class="prettyprint linenums">
icon&lt;i class="icon-rocket on-right on-left"
    style="background: red;
           color: white;
           padding: 10px;
           border-radius: 50%"&gt;&lt;/i&gt;rocket
</pre>
                ...
                <div class="tertiary-text no-display">
                    <h4>License info:</h4>
