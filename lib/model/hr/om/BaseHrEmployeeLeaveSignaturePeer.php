...
abstract class BaseHrEmployeeLeaveSignaturePeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Approval', 'Verified', 'HrEmployeeLeaveId', 'DateCreated', 'CreatedBy', 'ModifiedBy', 'DateModified', ),
		BasePeer::TYPE_COLNAME => array (HrEmployeeLeaveSignaturePeer::ID, HrEmployeeLeaveSignaturePeer::APPROVAL, HrEmployeeLeaveSignaturePeer::VERIFIED, HrEmployeeLeaveSignaturePeer::HR_EMPLOYEE_LEAVE_ID, HrEmployeeLeaveSignaturePeer::DATE_CREATED, HrEmployeeLeaveSignaturePeer::CREATED_BY, HrEmployeeLeaveSignaturePeer::MODIFIED_BY, HrEmployeeLeaveSignaturePeer::DATE_MODIFIED, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'approval', 'verified', 'hr_employee_leave_id', 'date_created', 'created_by', 'modified_by', 'date_modified', ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);

	
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Approval' => 1, 'Verified' => 2, 'HrEmployeeLeaveId' => 3, 'DateCreated' => 4, 'CreatedBy' => 5, 'ModifiedBy' => 6, 'DateModified' => 7, ),
		BasePeer::TYPE_COLNAME => array (HrEmployeeLeaveSignaturePeer::ID => 0, HrEmployeeLeaveSignaturePeer::APPROVAL => 1, HrEmployeeLeaveSignaturePeer::VERIFIED => 2, HrEmployeeLeaveSignaturePeer::HR_EMPLOYEE_LEAVE_ID => 3, HrEmployeeLeaveSignaturePeer::DATE_CREATED => 4, HrEmployeeLeaveSignaturePeer::CREATED_BY => 5, HrEmployeeLeaveSignaturePeer::MODIFIED_BY => 6, HrEmployeeLeaveSignaturePeer::DATE_MODIFIED => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'approval' => 1, 'verified' => 2, 'hr_employee_leave_id' => 3, 'date_created' => 4, 'created_by' => 5, 'modified_by' => 6, 'date_modified' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
