...
class AirParticleCountEdwardsGMapBuilder {

	
	const CLASS_NAME = 'lib.model.particle.map.AirParticleCountEdwardsGMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('air_particle_count_edwards_g');
		$tMap->setPhpName('AirParticleCountEdwardsG');
