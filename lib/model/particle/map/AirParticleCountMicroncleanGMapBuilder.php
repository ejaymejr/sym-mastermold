...
class AirParticleCountMicroncleanGMapBuilder {

	
	const CLASS_NAME = 'lib.model.particle.map.AirParticleCountMicroncleanGMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('air_particle_count_micronclean_g');
		$tMap->setPhpName('AirParticleCountMicroncleanG');
