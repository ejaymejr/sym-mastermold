...
class AirParticleCountEdwardsGCellMapBuilder {

	
	const CLASS_NAME = 'lib.model.particle.map.AirParticleCountEdwardsGCellMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('air_particle_count_edwards_g_cell');
		$tMap->setPhpName('AirParticleCountEdwardsGCell');
