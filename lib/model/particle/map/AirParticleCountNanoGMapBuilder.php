...
class AirParticleCountNanoGMapBuilder {

	
	const CLASS_NAME = 'lib.model.particle.map.AirParticleCountNanoGMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('air_particle_count_nano_g');
		$tMap->setPhpName('AirParticleCountNanoG');
