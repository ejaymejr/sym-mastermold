...
abstract class BaseAirParticleCountNanoG extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AirParticleCountNanoGPeer::ID;
		}
	...
	public function setDateRecord($v)
	{
		...
		if ($this->date_record !== $ts) {
			$this->date_record = $ts;
			$this->modifiedColumns[] = AirParticleCountNanoGPeer::DATE_RECORD;
		}
	...
	public function setTesterId($v)
	{
		...
		if ($this->tester_id !== $v || $v === 'null') {
			$this->tester_id = $v;
			$this->modifiedColumns[] = AirParticleCountNanoGPeer::TESTER_ID;
		}
	...
	public function setHumidity($v)
	{
		...
		if ($this->humidity !== $v || $v === 0) {
			$this->humidity = $v;
			$this->modifiedColumns[] = AirParticleCountNanoGPeer::HUMIDITY;
		}
	...
	public function setTemperature($v)
	{
		...
		if ($this->temperature !== $v || $v === 0) {
			$this->temperature = $v;
			$this->modifiedColumns[] = AirParticleCountNanoGPeer::TEMPERATURE;
		}
	...
	public function setDiffPressure($v)
	{
		...
		if ($this->diff_pressure !== $v || $v === 'null') {
			...
			$this->modifiedColumns[] = AirParticleCountNanoGPeer::DIFF_PRESSURE;
		}
	...
	public function setFrequency($v)
	{
		...
		if ($this->frequency !== $v || $v === 'null') {
			$this->frequency = $v;
			$this->modifiedColumns[] = AirParticleCountNanoGPeer::FREQUENCY;
		}
	...
	public function setRemark($v)
	{
		...
		if ($this->remark !== $v) {
			$this->remark = $v;
			$this->modifiedColumns[] = AirParticleCountNanoGPeer::REMARK;
		}
	...
	public function setDeleted($v)
	{
		...
		if ($this->deleted !== $v || $v === 'null') {
			$this->deleted = $v;
			$this->modifiedColumns[] = AirParticleCountNanoGPeer::DELETED;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ($this->date_created !== $ts) {
			...
			$this->modifiedColumns[] = AirParticleCountNanoGPeer::DATE_CREATED;
		}
	...
	public function setDateModified($v)
	{
		...
		if ($this->date_modified !== $ts) {
			...
			$this->modifiedColumns[] = AirParticleCountNanoGPeer::DATE_MODIFIED;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating AirParticleCountNanoG object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			AirParticleCountNanoGPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AirParticleCountNanoGPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += AirParticleCountNanoGPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AirParticleCountNanoGPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AirParticleCountNanoGPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = AirParticleCountNanoGPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AirParticleCountNanoGPeer::ID)) $criteria->add(AirParticleCountNanoGPeer::ID, $this->id);
		if ($this->isColumnModified(AirParticleCountNanoGPeer::DATE_RECORD)) $criteria->add(AirParticleCountNanoGPeer::DATE_RECORD, $this->date_record);
		if ($this->isColumnModified(AirParticleCountNanoGPeer::TESTER_ID)) $criteria->add(AirParticleCountNanoGPeer::TESTER_ID, $this->tester_id);
		if ($this->isColumnModified(AirParticleCountNanoGPeer::HUMIDITY)) $criteria->add(AirParticleCountNanoGPeer::HUMIDITY, $this->humidity);
		if ($this->isColumnModified(AirParticleCountNanoGPeer::TEMPERATURE)) $criteria->add(AirParticleCountNanoGPeer::TEMPERATURE, $this->temperature);
		if ($this->isColumnModified(AirParticleCountNanoGPeer::DIFF_PRESSURE)) $criteria->add(AirParticleCountNanoGPeer::DIFF_PRESSURE, $this->diff_pressure);
		if ($this->isColumnModified(AirParticleCountNanoGPeer::FREQUENCY)) $criteria->add(AirParticleCountNanoGPeer::FREQUENCY, $this->frequency);
		if ($this->isColumnModified(AirParticleCountNanoGPeer::REMARK)) $criteria->add(AirParticleCountNanoGPeer::REMARK, $this->remark);
		if ($this->isColumnModified(AirParticleCountNanoGPeer::DELETED)) $criteria->add(AirParticleCountNanoGPeer::DELETED, $this->deleted);
		if ($this->isColumnModified(AirParticleCountNanoGPeer::DATE_CREATED)) $criteria->add(AirParticleCountNanoGPeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(AirParticleCountNanoGPeer::DATE_MODIFIED)) $criteria->add(AirParticleCountNanoGPeer::DATE_MODIFIED, $this->date_modified);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AirParticleCountNanoGPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new AirParticleCountNanoGPeer();
		}
		return self::$peer;
	}
