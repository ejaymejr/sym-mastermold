...
abstract class BaseAirParticleCountEdwardsG extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = AirParticleCountEdwardsGPeer::ID;
		}
	...
	public function setDateRecord($v)
	{
		...
		if ($this->date_record !== $ts) {
			$this->date_record = $ts;
			$this->modifiedColumns[] = AirParticleCountEdwardsGPeer::DATE_RECORD;
		}
	...
	public function setTesterId($v)
	{
		...
		if ($this->tester_id !== $v || $v === 'null') {
			$this->tester_id = $v;
			$this->modifiedColumns[] = AirParticleCountEdwardsGPeer::TESTER_ID;
		}
	...
	public function setHumidity($v)
	{
		...
		if ($this->humidity !== $v || $v === 0) {
			$this->humidity = $v;
			$this->modifiedColumns[] = AirParticleCountEdwardsGPeer::HUMIDITY;
		}
	...
	public function setTemperature($v)
	{
		...
		if ($this->temperature !== $v || $v === 0) {
			$this->temperature = $v;
			$this->modifiedColumns[] = AirParticleCountEdwardsGPeer::TEMPERATURE;
		}
	...
	public function setDiffPressure($v)
	{
		...
		if ($this->diff_pressure !== $v || $v === 'null') {
			...
			$this->modifiedColumns[] = AirParticleCountEdwardsGPeer::DIFF_PRESSURE;
		}
	...
	public function setFrequency($v)
	{
		...
		if ($this->frequency !== $v || $v === 'null') {
			$this->frequency = $v;
			$this->modifiedColumns[] = AirParticleCountEdwardsGPeer::FREQUENCY;
		}
	...
	public function setRemark($v)
	{
		...
		if ($this->remark !== $v) {
			$this->remark = $v;
			$this->modifiedColumns[] = AirParticleCountEdwardsGPeer::REMARK;
		}
	...
	public function setDeleted($v)
	{
		...
		if ($this->deleted !== $v || $v === 'null') {
			$this->deleted = $v;
			$this->modifiedColumns[] = AirParticleCountEdwardsGPeer::DELETED;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ($this->date_created !== $ts) {
			...
			$this->modifiedColumns[] = AirParticleCountEdwardsGPeer::DATE_CREATED;
		}
	...
	public function setDateModified($v)
	{
		...
		if ($this->date_modified !== $ts) {
			...
			$this->modifiedColumns[] = AirParticleCountEdwardsGPeer::DATE_MODIFIED;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating AirParticleCountEdwardsG object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			AirParticleCountEdwardsGPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = AirParticleCountEdwardsGPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += AirParticleCountEdwardsGPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = AirParticleCountEdwardsGPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = AirParticleCountEdwardsGPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = AirParticleCountEdwardsGPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(AirParticleCountEdwardsGPeer::ID)) $criteria->add(AirParticleCountEdwardsGPeer::ID, $this->id);
		if ($this->isColumnModified(AirParticleCountEdwardsGPeer::DATE_RECORD)) $criteria->add(AirParticleCountEdwardsGPeer::DATE_RECORD, $this->date_record);
		if ($this->isColumnModified(AirParticleCountEdwardsGPeer::TESTER_ID)) $criteria->add(AirParticleCountEdwardsGPeer::TESTER_ID, $this->tester_id);
		if ($this->isColumnModified(AirParticleCountEdwardsGPeer::HUMIDITY)) $criteria->add(AirParticleCountEdwardsGPeer::HUMIDITY, $this->humidity);
		if ($this->isColumnModified(AirParticleCountEdwardsGPeer::TEMPERATURE)) $criteria->add(AirParticleCountEdwardsGPeer::TEMPERATURE, $this->temperature);
		if ($this->isColumnModified(AirParticleCountEdwardsGPeer::DIFF_PRESSURE)) $criteria->add(AirParticleCountEdwardsGPeer::DIFF_PRESSURE, $this->diff_pressure);
		if ($this->isColumnModified(AirParticleCountEdwardsGPeer::FREQUENCY)) $criteria->add(AirParticleCountEdwardsGPeer::FREQUENCY, $this->frequency);
		if ($this->isColumnModified(AirParticleCountEdwardsGPeer::REMARK)) $criteria->add(AirParticleCountEdwardsGPeer::REMARK, $this->remark);
		if ($this->isColumnModified(AirParticleCountEdwardsGPeer::DELETED)) $criteria->add(AirParticleCountEdwardsGPeer::DELETED, $this->deleted);
		if ($this->isColumnModified(AirParticleCountEdwardsGPeer::DATE_CREATED)) $criteria->add(AirParticleCountEdwardsGPeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(AirParticleCountEdwardsGPeer::DATE_MODIFIED)) $criteria->add(AirParticleCountEdwardsGPeer::DATE_MODIFIED, $this->date_modified);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(AirParticleCountEdwardsGPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new AirParticleCountEdwardsGPeer();
		}
		return self::$peer;
	}
