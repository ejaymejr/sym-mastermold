...
/**
 * Subclass for performing query and update operations on the 'air_particle_count_micronclean_g_cell' table.
 *
 * 
 *
 * @package lib.model.particle
 */ 
class AirParticleCountMicroncleanGCellPeer extends BaseAirParticleCountMicroncleanGCellPeer
{
