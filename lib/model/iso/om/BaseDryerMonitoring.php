...
abstract class BaseDryerMonitoring extends BaseObject  implements Persistent {
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::ID;
		}
	...
	public function setDateTime($v)
	{
		...
		if ($this->date_time !== $ts) {
			$this->date_time = $ts;
			$this->modifiedColumns[] = DryerMonitoringPeer::DATE_TIME;
		}
	...
	public function setMachineNo($v)
	{
		...
		if ($this->machine_no !== $v) {
			$this->machine_no = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::MACHINE_NO;
		}
	...
	public function setAm8($v)
	{
		...
		if ($this->am_8 !== $v) {
			$this->am_8 = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::AM_8;
		}
	...
	public function setAm9($v)
	{
		...
		if ($this->am_9 !== $v || $v === 0) {
			$this->am_9 = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::AM_9;
		}
	...
	public function setAm10($v)
	{
		...
		if ($this->am_10 !== $v || $v === 0) {
			$this->am_10 = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::AM_10;
		}
	...
	public function setAm11($v)
	{
		...
		if ($this->am_11 !== $v || $v === 0) {
			$this->am_11 = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::AM_11;
		}
	...
	public function setNn12($v)
	{
		...
		if ($this->nn_12 !== $v || $v === 0) {
			$this->nn_12 = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::NN_12;
		}
	...
	public function setPm1($v)
	{
		...
		if ($this->pm_1 !== $v || $v === 0) {
			$this->pm_1 = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::PM_1;
		}
	...
	public function setPm2($v)
	{
		...
		if ($this->pm_2 !== $v || $v === 0) {
			$this->pm_2 = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::PM_2;
		}
	...
	public function setPm3($v)
	{
		...
		if ($this->pm_3 !== $v || $v === 0) {
			$this->pm_3 = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::PM_3;
		}
	...
	public function setPm4($v)
	{
		...
		if ($this->pm_4 !== $v || $v === 0) {
			$this->pm_4 = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::PM_4;
		}
	...
	public function setPm5($v)
	{
		...
		if ($this->pm_5 !== $v || $v === 0) {
			$this->pm_5 = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::PM_5;
		}
	...
	public function setPm6($v)
	{
		...
		if ($this->pm_6 !== $v || $v === 0) {
			$this->pm_6 = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::PM_6;
		}
	...
	public function setPm7($v)
	{
		...
		if ($this->pm_7 !== $v || $v === 0) {
			$this->pm_7 = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::PM_7;
		}
	...
	public function setPm8($v)
	{
		...
		if ($this->pm_8 !== $v || $v === 0) {
			$this->pm_8 = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::PM_8;
		}
	...
	public function setPm9($v)
	{
		...
		if ($this->pm_9 !== $v || $v === 0) {
			$this->pm_9 = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::PM_9;
		}
	...
	public function setPm10($v)
	{
		...
		if ($this->pm_10 !== $v || $v === 0) {
			$this->pm_10 = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::PM_10;
		}
	...
	public function setTester($v)
	{
		...
		if ($this->tester !== $v) {
			$this->tester = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::TESTER;
		}
	...
	public function setRemark($v)
	{
		...
		if ($this->remark !== $v) {
			$this->remark = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::REMARK;
		}
	...
	public function setDateCreated($v)
	{
		...
		if ($this->date_created !== $ts) {
			...
			$this->modifiedColumns[] = DryerMonitoringPeer::DATE_CREATED;
		}
	...
	public function setCreatedBy($v)
	{
		...
		if ($this->created_by !== $v) {
			$this->created_by = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::CREATED_BY;
		}
	...
	public function setDateModified($v)
	{
		...
		if ($this->date_modified !== $ts) {
			...
			$this->modifiedColumns[] = DryerMonitoringPeer::DATE_MODIFIED;
		}
	...
	public function setModifiedBy($v)
	{
		...
		if ($this->modified_by !== $v) {
			$this->modified_by = $v;
			$this->modifiedColumns[] = DryerMonitoringPeer::MODIFIED_BY;
		}
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			throw new PropelException("Error populating DryerMonitoring object", $e);
		}
	}
	...
	public function delete($con = null)
	{
		...
		try {
			$con->begin();
			DryerMonitoringPeer::doDelete($this, $con);
	...
	protected function doSave($con)
	{
		$affectedRows = 0; 		if (!$this->alreadyInSave) {
			$this->alreadyInSave = true;
						...
						if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = DryerMonitoringPeer::doInsert($this, $con);
					$affectedRows += 1; 										 										 
					$this->setId($pk);  
					$this->setNew(false);
				} else {
					$affectedRows += DryerMonitoringPeer::doUpdate($this, $con);
				}
				$this->resetModified(); 			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = DryerMonitoringPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = DryerMonitoringPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = DryerMonitoringPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(DryerMonitoringPeer::ID)) $criteria->add(DryerMonitoringPeer::ID, $this->id);
		if ($this->isColumnModified(DryerMonitoringPeer::DATE_TIME)) $criteria->add(DryerMonitoringPeer::DATE_TIME, $this->date_time);
		if ($this->isColumnModified(DryerMonitoringPeer::MACHINE_NO)) $criteria->add(DryerMonitoringPeer::MACHINE_NO, $this->machine_no);
		if ($this->isColumnModified(DryerMonitoringPeer::AM_8)) $criteria->add(DryerMonitoringPeer::AM_8, $this->am_8);
		if ($this->isColumnModified(DryerMonitoringPeer::AM_9)) $criteria->add(DryerMonitoringPeer::AM_9, $this->am_9);
		if ($this->isColumnModified(DryerMonitoringPeer::AM_10)) $criteria->add(DryerMonitoringPeer::AM_10, $this->am_10);
		if ($this->isColumnModified(DryerMonitoringPeer::AM_11)) $criteria->add(DryerMonitoringPeer::AM_11, $this->am_11);
		if ($this->isColumnModified(DryerMonitoringPeer::NN_12)) $criteria->add(DryerMonitoringPeer::NN_12, $this->nn_12);
		if ($this->isColumnModified(DryerMonitoringPeer::PM_1)) $criteria->add(DryerMonitoringPeer::PM_1, $this->pm_1);
		if ($this->isColumnModified(DryerMonitoringPeer::PM_2)) $criteria->add(DryerMonitoringPeer::PM_2, $this->pm_2);
		if ($this->isColumnModified(DryerMonitoringPeer::PM_3)) $criteria->add(DryerMonitoringPeer::PM_3, $this->pm_3);
		if ($this->isColumnModified(DryerMonitoringPeer::PM_4)) $criteria->add(DryerMonitoringPeer::PM_4, $this->pm_4);
		if ($this->isColumnModified(DryerMonitoringPeer::PM_5)) $criteria->add(DryerMonitoringPeer::PM_5, $this->pm_5);
		if ($this->isColumnModified(DryerMonitoringPeer::PM_6)) $criteria->add(DryerMonitoringPeer::PM_6, $this->pm_6);
		if ($this->isColumnModified(DryerMonitoringPeer::PM_7)) $criteria->add(DryerMonitoringPeer::PM_7, $this->pm_7);
		if ($this->isColumnModified(DryerMonitoringPeer::PM_8)) $criteria->add(DryerMonitoringPeer::PM_8, $this->pm_8);
		if ($this->isColumnModified(DryerMonitoringPeer::PM_9)) $criteria->add(DryerMonitoringPeer::PM_9, $this->pm_9);
		if ($this->isColumnModified(DryerMonitoringPeer::PM_10)) $criteria->add(DryerMonitoringPeer::PM_10, $this->pm_10);
		if ($this->isColumnModified(DryerMonitoringPeer::TESTER)) $criteria->add(DryerMonitoringPeer::TESTER, $this->tester);
		if ($this->isColumnModified(DryerMonitoringPeer::REMARK)) $criteria->add(DryerMonitoringPeer::REMARK, $this->remark);
		if ($this->isColumnModified(DryerMonitoringPeer::DATE_CREATED)) $criteria->add(DryerMonitoringPeer::DATE_CREATED, $this->date_created);
		if ($this->isColumnModified(DryerMonitoringPeer::CREATED_BY)) $criteria->add(DryerMonitoringPeer::CREATED_BY, $this->created_by);
		if ($this->isColumnModified(DryerMonitoringPeer::DATE_MODIFIED)) $criteria->add(DryerMonitoringPeer::DATE_MODIFIED, $this->date_modified);
		if ($this->isColumnModified(DryerMonitoringPeer::MODIFIED_BY)) $criteria->add(DryerMonitoringPeer::MODIFIED_BY, $this->modified_by);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(DryerMonitoringPeer::ID, $this->id);
	...
	{
		if (self::$peer === null) {
			self::$peer = new DryerMonitoringPeer();
		}
		return self::$peer;
	}
