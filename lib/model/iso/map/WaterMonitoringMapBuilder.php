...
class WaterMonitoringMapBuilder {

	
	const CLASS_NAME = 'lib.model.iso.map.WaterMonitoringMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('water_monitoring');
		$tMap->setPhpName('WaterMonitoring');
