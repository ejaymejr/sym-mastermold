...
class LabelCostCenterMapBuilder {

	
	const CLASS_NAME = 'lib.model.hgas3.map.LabelCostCenterMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('label_cost_center');
		$tMap->setPhpName('LabelCostCenter');
		...
		$tMap->addColumn('COST_CENTER', 'CostCenter', 'string', CreoleTypes::VARCHAR, false, 40);
