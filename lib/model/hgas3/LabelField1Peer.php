...
/**
 * Subclass for performing query and update operations on the 'label_field1' table.
 *
 * 
 *
 * @package lib.model.hgas3
 */ 
class LabelField1Peer extends BaseLabelField1Peer
{
	...
	public static function GetListByCompanyId($cID)
	{
		$c = new Criteria();
		$c->add(self::LABEL_COMPANY_ID, $cID);
		$c->addAscendingOrderByColumn(self::NAME);
