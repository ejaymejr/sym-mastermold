...
class RejectColorAttrMapBuilder {

	
	const CLASS_NAME = 'lib.model.reject.map.RejectColorAttrMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('reject_color_attr');
		$tMap->setPhpName('RejectColorAttr');
